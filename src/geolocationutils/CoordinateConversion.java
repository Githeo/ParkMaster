...
public class CoordinateConversion
{
  ...
  //adding(giulio) method to directly get northing and easting coordinates from lat/long
  public double[] getNorthEastFromLatLong(double latitude, double longitude)
  {
    LatLon2UTM c = new LatLon2UTM();
    return c.getNorthEastFromLatLong(latitude, longitude);
  }
